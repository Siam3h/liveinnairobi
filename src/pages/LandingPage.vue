<template>
  ...
  <!-- Trusted Partners Section with Sliding Logos -->
  <div class="bg-yellow-400 py-8 overflow-hidden relative">
    <div class="logos-slider flex items-center space-x-8 animate-scroll">
      <img 
        v-for="logo in logos" 
        :key="logo.src" 
        :src="logo.src" 
...
import api from '../api';
import airbnbLogo from '../assets/images/airbnb1.jpeg';
  ...
  data() {
    return {
      ...
      logos: [
        ...
        {src: airbnbLogo, alt: "Local Airbnb Logo" },
