...
const Blogs = () => import('../components/BlogList.vue');
const BlogsCreate = () => import('../components/BlogCreate.vue');
const BlogUpdate = () => import('../components/BlogUpdate.vue');
const BlogDetail = () => import('../components/BlogDetail.vue');
const Events = () => import('../components/EventList.vue');
const EventCreate = () => import('../components/EventsCreate.vue');
const EventUpdate = () => import('../components/EventsUpdate.vue');
