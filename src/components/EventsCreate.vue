            ...
            <form @submit.prevent="createEvent" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input v-model="eventData.country"
                               type="text"
                               id="country"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                               placeholder="Country" />
                ...
                <div>
                    ...
                    <textarea v-model="eventData.content"
                              id="content"
                              rows="4"
                              required
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input v-model="eventData.event_date"
                               type="datetime-local"
                               id="event_date"
                               required
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                    ...
                    <div>
                        ...
                        <input v-model.number="eventData.price"
                               type="number"
                               id="price"
                               min="0"
                               required
