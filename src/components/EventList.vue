    ...
    <section class="bg-gray-50 py-12">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div v-else>
                ...
                <!-- Recent Events Cards Section -->
                <div class="mb-12">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Recent Events</h2>
                    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        <!-- Event Card 1 -->
                        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                            <img src="https://images.pexels.com/photos/1190298/pexels-photo-1190298.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                 alt="Music Festival"
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-gray-600 mb-4">Experience the best of Kenyan music with top artists performing live at Uhuru Park this weekend.</p>
                        ...
                        <!-- Event Card 2 -->
                        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                            <img src="https://images.pexels.com/photos/2263436/pexels-photo-2263436.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                 alt="Tech Conference"
                                 class="w-full h-48 object-cover">
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-2">
                                ...
                                <p class="text-gray-600 mb-4">Join leading tech innovators and entrepreneurs as they discuss the future of African technology.</p>
                                <div class="flex justify-between items-center text-sm">
                                    <span class="text-gray-500">
                                        <svg class="h-4 w-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-gray-600 mb-4">Sample delicious Kenyan cuisine from all regions at this annual food festival in the city center.</p>
                                <div class="flex justify-between items-center text-sm">
                                    <span class="text-gray-500">
                                        <svg class="h-4 w-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
