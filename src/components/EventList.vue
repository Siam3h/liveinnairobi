                    ...
                    <div class="bg-white rounded-lg shadow-xl overflow-hidden">
                        <div class="md:flex">
                            <div class="md:flex-shrink-0">
                                <img 
                                    :src="mostRecentEvent.thumbnail_url || '/default-event.jpg'" 
...
export default {
    setup() {
        ...
        const mostRecentEvent = computed(() => {
            ...
            return events.value[0]; // Events are already sorted by created_at from the backend
        });

        // Compute unique categories from events
        ...
        const filteredEvents = computed(() => {
            if (!selectedCategory.value) {
                return events.value.slice(1); // Exclude the most recent event
            }
